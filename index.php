...
<div class="content">
    ...
    <script>
        const auditorPieChartData = {
            labels: <?= json_encode(['surat', 'Document']) ?>, // Update 'Transaksi Perusahaan' to 'Document'
    ...
    <script>
        const adminFinancePieChartData = {
            labels: <?= json_encode(['surat', 'Dokumen Transaksi Perusahaan']) ?>, // Change 'Document' to 'Transaksi Perusahaan' here
