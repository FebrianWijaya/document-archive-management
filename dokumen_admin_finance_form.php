...
<div class="content">
    ...
    <form class="user-form" action="create_folder.php" method="post">
        ...
        <div class="form-input">
            ...
            <input type="text" name="division" id="division" value="admin dan finance" readonly>
        </div>

        <div class="form-input">
            <label class="form-label" for="documentType">Document Type:</label>
            <input type="text" name="documentType" id="documentType" value="Transaksi Perusahaan" readonly>
        </div>
