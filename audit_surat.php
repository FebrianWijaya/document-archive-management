...
<div class="content">
    ...
    <h1>Welcome to Surat Audit Management</h1>
    <p>This is where you display Surat Audit-related information.</p>
    ...
    <a href="surat_auditor_form.php" class="add-button">Create Folder</a>
    ...
    if (!empty($years)) {
        ...
        while ($folderRow = mysqli_fetch_assoc($foldersResult)) {
            ...
            echo '<td>';
            echo "<a href='audit_surat_history.php?folder=$folderName' class='history-button'>History</a>";
        ...
        if (!empty($selectedCompany)) {
            ...
            $companyQuery = "SELECT DISTINCT company_name FROM folders WHERE division = 'audit' AND document_type = 'surat'";
