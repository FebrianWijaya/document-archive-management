...
<div class="content">
   ...
   <!-- Display List of Users in a Table -->
    ...
    <table>
        ...
        $sql = "SELECT id, no_induk, nama_depan, nama_belakang, username, divisi, jabatan FROM users $whereClause";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($_SESSION['divisi'] === 'Administrator') {
                    ...
                    echo "<td>";
                    echo "<a href='edit_user.php?id=" . $row["id"] . "' class='edit-button'>Edit</a> | ";
                    echo "<a href='delete_user.php?id=" . $row["id"] . "' class='delete-button'>Delete</a>";
                    echo "</td>";
                }
