...
if ($stmt = $con->prepare('SELECT nama_depan, nama_belakang FROM client_users WHERE id = ?')) {
...
<div class="user-info">
    ...
    <br>
    <span class="user-info-label user-info-divisi">Perusahaan:</span> <strong><?php echo $divisi; ?></strong>
</div>
