...
<div class="content">
    ...
    <h1>Welcome to Surat Admin Management</h1>
    <p>This is where you display Surat Admin-related information.</p>
    ...
    <a href="surat_admin_finance_form.php" class="add-button">Create Folder</a>
    ...
    if (!empty($years)) {
        ...
        $foldersQuery = $conn->prepare("SELECT company_name, folder_name, file_type, years FROM folders 
                WHERE division = 'admin dan finance' 
                AND document_type = 'surat' 
        ...
        while ($folderRow = mysqli_fetch_assoc($foldersResult)) {
            ...
            echo '<td>';
            echo "<a href='admin_surat_history.php?folder=$folderName' class='history-button'>History</a>";
        ...
        if (!empty($selectedCompany)) {
            ...
            $companyQuery = "SELECT DISTINCT company_name FROM folders WHERE division = 'admin dan finance' AND document_type = 'surat'";
