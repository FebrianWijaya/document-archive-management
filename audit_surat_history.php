    ...
    <input type="submit" name="upload" value="Upload File">
        ...
        <table border="1">
            ...
            <tbody>
                ...
                $selectFilesQuery = "SELECT file_name, upload_date, publisher, version, comment FROM uploaded_files WHERE folder_name = ? AND division = 'Auditor' AND file_type = 'surat'";
                ...
                while ($stmt->fetch()) {
                    ...
                    if ($_SESSION['divisi'] === 'Administrator') {
                        echo '<a class="delete-button" href="delete_audit_surat.php?folder=' . urlencode($folder) . '&file=' . urlencode($fileName) . '" style="background-color: #FF4D4D; color: #fff; text-decoration: none; border: none; border-radius: 5px; cursor: pointer; display: inline-block; padding: 5px 10px;margin-left: 5px; margin-right: 5px;">Delete</a>';
                    }
                    echo '</td>';
