...
<div class="content">
    ...
    <h1>Welcome to Transaksi Dokumen Management</h1>
    <p>This is where you display Transaksi Dokumen-related information.</p>
    ...
    <a href="dokumen_admin_finance_form.php" class="add-button">Create Folder</a>
    ...
    if (!empty($years)) {
        ...
        $foldersQuery = $conn->prepare("SELECT company_name, folder_name, file_type, years FROM folders 
                ...
                AND document_type = 'Transaksi Perusahaan' 
        ...
        if (!empty($selectedCompany)) {
            ...
            $companyQuery = "SELECT DISTINCT company_name FROM folders WHERE division = 'admin dan finance' AND document_type = 'Transaksi Perusahaan'";
